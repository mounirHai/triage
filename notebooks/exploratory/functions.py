...
def cluster_profile(df):
    dfc = df.groupby("cluster").agg({ 
        ...
        "forlopslengde": "median",
         "antallKontakter": "median",
        "kontaktTypeGrp_Direkte_pasientkontakt": "median",
         "kontaktTypeGrp_Indirekte_pasientkontakt": "median",
         "polUtforendeGrp_Lege": "median",
         "polUtforendeGrp_Annet_helsepersonell": "median",
        "polUtforendeGrp_Psykolog": "median",
        "ICD10Kapittel": lambda x: x.value_counts().index[0]
